...
export default function SignUpForm({onDismiss, onLoginInsteadClicked}: SignUphtmlFormProps) {
  ...
  return (
    <div className="rounded-sm  shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center bg-[url('/uploads/site-pictures/roll3.jpg')]">
          ...
          <div className="w-full border-stroke bg-white-500 dark:border-strokedark xl:w-1/2 xl:border-l-2">
