...
export default function EventLogList() {
    ...
    return (
        <div className="col-span-12 h-72 overflow-auto rounded-md border border-stroke bg-white-500 p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
