...
export default function MemberListEntry({firstname, lastname, belt, numberOfStripes, memebrsLen, index, email, joinDate, profilePicUrl}: MemberListItemProps) {
    return (
      <div className={clsx(index != memebrsLen!-1 ? " border-b grid grid-cols-3 bg-white-500 border-stroke dark:border-strokedark sm:grid-cols-5" : "grid grid-cols-3 border-stroke dark:border-strokedark sm:grid-cols-5")}>
