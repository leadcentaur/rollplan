...
export default function ProfilePictureInputField({register, label, error, placeholder, ...props}: ProfilePictureInputFieldProps & ComponentProps<"input">) {
    ...
    return (
      ...
      <div
        id="FileUpload"
        className="relative block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-red-500 bg-gray py-4 px-4 dark:bg-meta-4 sm:py-7.5"
      >
        <input
          type="file"
          {...register} 
        ...
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          <p>
            <span className="text-red-600">Click to upload</span> or
            drag and drop
          </p>
